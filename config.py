...
SIGNAL_TIMEFRAME = "15m"         # підтвердження сигналу шукаємо на молодшому ТФ
...
RADAR_DISTANCE_PCT = 1.5          # слати радар-сповіщення, коли ціна на такій % відстані від рівня
RADAR_MIN_LEVEL_STRENGTH = 3      # радар шле лише для рівнів такої сили і вище
RETEST_MOVE_AWAY_PCT = 2.0        # ціна має відійти на цей % від рівня, щоб наступне наближення рахувалось як "ретест"
